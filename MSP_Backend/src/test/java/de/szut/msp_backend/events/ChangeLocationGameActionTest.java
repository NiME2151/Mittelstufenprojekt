...
public class ChangeLocationGameActionTest
{
    ...
    void testDoAction()
    {
        ...
        ChangeLocationGameAction gameAction = new ChangeLocationGameAction(Map.streets.getNodeId()); //try to go to the forest
        ...
        gameAction = new ChangeLocationGameAction(Map.Club.getNodeId());
