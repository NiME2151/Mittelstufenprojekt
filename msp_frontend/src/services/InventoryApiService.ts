...
class InventoryApiService {
  ...
  public static async getAllItems(): Promise<number> {
  ...
  public static async isNotFull(): Promise<number> {
  ...
  public static async isItemPresent(item: GenericItem): Promise<number> {
