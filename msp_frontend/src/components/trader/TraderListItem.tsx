...
import {setMoney} from "../../redux/slices/globals";
...
export const TraderListItem: React.FC<TraderListItemProps> = ({item, getTrader, getTradeItemsOfTrader, getTradeItemsOfPlayer, traderTab, traderId, actionStatus, setActionStatus}): JSX.Element => {
