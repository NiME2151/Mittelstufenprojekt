...
export class MarketItem implements GenericItem {
  ...
  constructor(description: string, displayName: string, itemID: number, itemType: ItemType, rarity: Rarity, standardValue: number, marketValue: number) {
